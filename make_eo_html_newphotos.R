...
eo_import <- readRDS('../eo_data/data/eo_2024.rds')
...
eo <- eo_import %>% 
  ...
  rename("Contraception" = "SP.DYN.CONM.ZS") %>%    # was "Contraception" 
  rename("GDP_pp" = "NY.GDP.PCAP.CD") %>% 
  rename("Species" = "Species_2024") %>%            # was "Species_2022_2"
